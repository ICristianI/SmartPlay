document.addEventListener("DOMContentLoaded", function () {
  ...
  function actualizarListaFichas() {
      ...
      agregarEventosEliminar("eliminar-ficha", fichasSeleccionadas, actualizarListaFichas, ".ficha-item");
  }
  ...
  function actualizarListaJuegos() {
      ...
      agregarEventosEliminar("eliminar-juego", juegosSeleccionados, actualizarListaJuegos, ".juego-item");
  }

  // Función para crear elementos de la lista con una "×" más sutil
  ...
  function agregarEventosEliminar(clase, setSeleccionados, actualizarLista, selectorItem) {
      document.querySelectorAll(`.${clase}`).forEach((btn) => {
          btn.addEventListener("click", function () {
              ...
              if (item) item.classList.remove("ficha-seleccionada", "juego-seleccionado");
