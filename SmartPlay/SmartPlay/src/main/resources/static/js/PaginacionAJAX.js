  ...
  fetch(url, {
    ...
    .then((html) => {
      ...
      if (tipo === "fichas") {
        ...
        let contenedorPaginacionFichas = document.querySelector(
          "#navPaginacionFichas"
        );
        if (nuevaPaginacionFichas && contenedorPaginacionFichas) {
          contenedorPaginacionFichas.innerHTML =
            nuevaPaginacionFichas.innerHTML;
        }
      } else if (tipo === "juegos") {
        ...
        let contenedorPaginacionJuegos = document.querySelector(
          "#navPaginacionJuegos"
        );
        if (nuevaPaginacionJuegos && contenedorPaginacionJuegos) {
          contenedorPaginacionJuegos.innerHTML =
            nuevaPaginacionJuegos.innerHTML;
        }
      }
